...
<body>
    ...
    <section class="admin-section">
        ...
        <table class="product-table">
            ...
            <?php foreach ($products as $p): ?>
                <tr id="row-<?= $p['id'] ?>">
                    ...
                    <td>
                        <button class="btn-action" onclick="editSize(<?= $p['id'] ?>, '<?= htmlspecialchars($p['size']) ?>')">
                            <?= htmlspecialchars($p['size']) ?>
                        </button>
                    </td>
                    <td><?= htmlspecialchars($p['description']) ?></td>
                    <td>
                        <button class="btn-action" onclick="removeProduct(<?= $p['id'] ?>)">Remove</button>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        ...
        <div class="add-form">
            ...
            <form id="addForm" method="POST" action="add_product.php">
    ...
    <script>
        function showSidebar() {
            document.querySelector('.sidebar').style.inset = '0 0 0 auto';
        }
        function hideSidebar() {
            document.querySelector('.sidebar').style.inset = '0 -250px 0 auto';
        }
